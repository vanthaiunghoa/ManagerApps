...
@property (strong, nonatomic) QRCodeView *myQRCodeView;
...
- (void)configUI{
    ...
    CGRect scanRect = CGRectMake(padding, SCREEN_HEIGHT/4, width, width);
    ...
    if (!_myQRCodeView) {
        _myQRCodeView = [[QRCodeView alloc] initWithFrame:self.view.bounds];
        _myQRCodeView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.2];
        _myQRCodeView.scanRect = scanRect;
    }
