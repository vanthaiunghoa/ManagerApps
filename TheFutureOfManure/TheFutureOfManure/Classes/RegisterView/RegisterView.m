...
- (id)init
{
    ...
    NSMutableAttributedString *str = [[NSMutableAttributedString alloc] initWithString:@"注册使用农肥未来即视为同意《农肥未来软件注册协议》"];
    ...
    [str yy_setColor:[UIColor colorWithRGB:108 green:189 blue:117] range:NSMakeRange(13, 12)];
    ...
    [labAgreement makeConstraints:^(MASConstraintMaker *make) {
