...
//    _borderButtonColor = RGB(205, 205, 205);
    ...
    [self setBackgroundColor:RGB(240, 241, 242)];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        CGFloat rightW = 60;
        CGFloat rightH = 44;
        CGFloat rightX = CGRectGetWidth([UIScreen mainScreen].bounds) - rightW - 10;
        CGFloat rightY = 0;
        _buttonRight = [[UIButton alloc]initWithFrame:CGRectMake(rightX, rightY, rightW, rightH)];
        [_buttonRight setTitleColor:RGB(22, 132, 251) forState:UIControlStateNormal];
