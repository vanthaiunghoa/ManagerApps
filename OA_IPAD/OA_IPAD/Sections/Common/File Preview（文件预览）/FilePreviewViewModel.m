...
@implementation FilePreviewViewModel
...
- (RACSignal *)saveAttatchFile:(id<AttatchFileModel>)attatchFile
    ...
    NSString *requestURL = [NSString stringWithFormat:@"%@Handlers/QWUpLoaderHandler.ashx?GUID=%@", kBaseURL, attatchFile.identifier];
