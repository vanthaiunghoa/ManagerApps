...
@interface SendPrewViewController ()<UITableViewDelegate, UITableViewDataSource, SendHandlerCellDelegate>
...
@implementation SendPrewViewController
...
- (void)requestDataRefresh:(BOOL)refresh
{
    ...
    NSDictionary *params = [NSMutableDictionary dictionaryWithDictionary:  @{@"PageSize": @10, @"PageNum": @(self.currentPage), @"SearchType":@"Finish"}];
