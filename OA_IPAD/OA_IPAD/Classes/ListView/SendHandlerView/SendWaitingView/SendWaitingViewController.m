...
@interface SendWaitingViewController ()<UITableViewDelegate, UITableViewDataSource, SendHandlerCellDelegate>
...
- (void)requestDataRefresh:(BOOL)refresh
{
    ...
    NSDictionary *params = [NSMutableDictionary dictionaryWithDictionary:  @{@"PageSize": @10, @"PageNum": @(self.currentPage), @"SearchType":@"WaiteHandle"}];
