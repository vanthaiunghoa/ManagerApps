...
@interface ReceiveAllViewController ()<UITableViewDelegate, UITableViewDataSource, ReceiveHandlerCellDelegate>
...
@implementation ReceiveAllViewController
...
- (void)requestDataRefresh:(BOOL)refresh
{
    ...
    NSDictionary *params = [NSMutableDictionary dictionaryWithDictionary:  @{@"PageSize": @10, @"PageNum": @(self.currentPage), @"BLState":@"ALL"}];
