...
@implementation ReceiveDoneViewController
...
- (void)requestDataRefresh:(BOOL)refresh
{
    ...
    NSDictionary *params = [NSMutableDictionary dictionaryWithDictionary:  @{@"PageSize": @10, @"PageNum": @(self.currentPage), @"BLState":@"1"}];
