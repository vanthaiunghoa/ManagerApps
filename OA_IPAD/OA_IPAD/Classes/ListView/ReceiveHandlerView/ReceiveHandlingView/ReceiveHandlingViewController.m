...
@interface ReceiveHandlingViewController ()<UITableViewDelegate, UITableViewDataSource, ReceiveHandlerCellDelegate>
...
@implementation ReceiveHandlingViewController
...
- (void)requestDataRefresh:(BOOL)refresh
{
    ...
    NSDictionary *params = [NSMutableDictionary dictionaryWithDictionary:  @{@"PageSize": @10, @"PageNum": @(self.currentPage), @"BLState":@"2"}];
