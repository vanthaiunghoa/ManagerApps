...
//    NSString *urlStr = [NSString stringWithFormat:@"http://121.15.203.82:9210/DMS_Phone_SLJ/Main/Index_SLJ.aspx?cmd={UserID:\"%@\",UserPsw:\"%@\"}", userModel.username, userModel.password];
//    NSString *urlStr = @"http://121.15.203.82:9210/DMS_Phone_SLJ/Main/Index_SLJ.aspx";
