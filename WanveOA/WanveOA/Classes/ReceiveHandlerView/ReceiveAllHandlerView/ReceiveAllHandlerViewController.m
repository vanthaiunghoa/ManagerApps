#import "ReceiveAllHandlerViewController.h"
...
@interface ReceiveAllHandlerViewController()<SWTableViewCellDelegate>
/** 用来显示的假数据 */
...
@implementation ReceiveAllHandlerViewController
...
//    [self.navigationController pushViewController:[NSClassFromString(@"ReceiveHandlerDetailViewController") new] animated:YES];
}
