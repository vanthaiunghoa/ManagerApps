#import "ReceiveNeedHandlerViewController.h"
...
@interface ReceiveNeedHandlerViewController()<SWTableViewCellDelegate>
/** 用来显示的假数据 */
...
@implementation ReceiveNeedHandlerViewController
...
- (void)download:(NSInteger)page
{
    ...
    // 2.发送请求
    NSString *jsonRequest = [NSString stringWithFormat:@"{\"ActiveCode\":\"%@\",\"PageSize\":\"10\",\"PageNum\":\"%zd\",\"BLState\":\"0\"}", userModel.activeCode, self.page];
//    NSString *state = @"1";
