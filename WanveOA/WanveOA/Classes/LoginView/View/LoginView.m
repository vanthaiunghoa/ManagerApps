...
//    bkg.image = [UIImage imageNamed:@"login_bkg"]; // 大图耗内存
    ...
    [company mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(self.mas_centerX);
        make.top.equalTo(logoIcon.mas_bottom).offset(H(10));
    ...
    [titleLab mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(company.mas_bottom).with.offset(H(15));
        make.left.right.equalTo(self);
    }];
    ...
    [usernameBkg mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(self.mas_centerX);
        make.top.equalTo(titleLab.mas_bottom).with.offset(H(40));
...
//        make.width.equalTo(@(261));
    ...
    [self.passwordTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.eyeBtn.mas_left).offset(W(-12));
    }];
    ...
    [vpnBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(loginBtn.mas_bottom).offset(H(20));
