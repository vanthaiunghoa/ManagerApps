#import "SendWaitHandlerViewController.h"
...
@interface SendWaitHandlerViewController()<SWTableViewCellDelegate>
/** 用来显示的假数据 */
...
@implementation SendWaitHandlerViewController
...
- (void)download:(NSInteger)page
{
    ...
    // 2.发送请求
    NSString *jsonRequest = [NSString stringWithFormat:@"{\"ActiveCode\":\"%@\",\"PageSize\":\"10\",\"PageNum\":\"%zd\",\"SearchType\":\"WaitHandle\"}", userModel.activeCode, self.page];
    //    NSString *state = @"1";
