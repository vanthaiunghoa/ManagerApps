#import "SendNeedHandlerViewController.h"
...
@interface SendNeedHandlerViewController()<SWTableViewCellDelegate>
/** 用来显示的假数据 */
...
@implementation SendNeedHandlerViewController
...
- (void)download:(NSInteger)page
{
    ...
    // 2.发送请求
    NSString *jsonRequest = [NSString stringWithFormat:@"{\"ActiveCode\":\"%@\",\"PageSize\":\"10\",\"PageNum\":\"%zd\",\"SearchType\":\"CanHandle\"}", userModel.activeCode, self.page];
//    NSString *state = @"1";
