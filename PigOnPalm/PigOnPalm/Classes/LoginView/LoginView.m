...
//    }];
    ...
    logoIcon.image = [UIImage imageNamed:@"logo-pig"];
...
//    [cleanPassword setImage:[UIImage imageNamed:@"clear"] forState:UIControlStateNormal];
    ...
    [self.loginBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRGB:243 green:147 blue:49]] forState:UIControlStateNormal];
    ...
    [btnRegister setTitleColor:[UIColor colorWithRGB:243 green:147 blue:49] forState:UIControlStateNormal];
