...
@property (nonatomic, strong) IconLabelModel *model;

- (void)updateLayoutBySize:(CGSize)size finished:(void (^)(IconLabel *item))finished; // 属性赋值后需更新布局

@end

@interface IconLabelModel : NSObject
